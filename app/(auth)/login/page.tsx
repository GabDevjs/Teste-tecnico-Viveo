...
import { UserLoginForm } from "@/components/user/user-login-auth";
...
export const metadata: Metadata = {
  ...
  description:
    "Faça login na plataforma para acessar o conteúdo exclusivo e personalizado.",
};
        ...
        <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
          <div className="flex flex-col space-y-2 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Entre com seus dados de Login para acessar a plataforma
            </p>
          </div>
          <UserLoginForm />
